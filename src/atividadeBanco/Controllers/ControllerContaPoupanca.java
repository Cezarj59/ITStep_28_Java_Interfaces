...
import atividadeBanco.classes.ContaPoupanca;
...
public class ControllerContaPoupanca {
    ...
    public static void addContaPoupanca(ContaPoupanca d) {
        Connection conn = BancoDados.conectar();

        try {
            String sql = "INSERT INTO ContaPoupanca (senha,login,nome,conta,agencia) VALUES (?,?,?)";
